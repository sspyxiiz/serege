    ...
    <section className="relative w-full h-screen mx-auto">
      <div className={`${styles.paddingX} 
        absolute inset-0 top-[120px] max-w-7xl mx-auto flex flex-row items-start gap-5`}>
          ...
          <div>
            <h1 className={`${styles.heroHeadText} text-white`}>Hi, I'm  <span className="text-[#915eff]">Ivan
            </span></h1>
        ...
        <a href="#about">
          <div className="w-[35px] h-[64px] rounded-3xl border-4 border-secondary
             flex justify-center items-start p-2">
              <motion.div animate ={{
                  y: [0, 24, 0]//говорим что элемент будет двигаться по оси y на 24px вниз а потом снова вверх
                }}
                transition={{
                  duration: 1.5,
                  repeat: Infinity,
